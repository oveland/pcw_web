...
class EventsReportMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $email = $this->view('email.reports.consolidated.daily')->subject(__('Route') . " • " . __('Report events daily') ." ".$this->company->short_name." ". " | $this->dateReport ".($this->production ? '':'> Para revisar'));
