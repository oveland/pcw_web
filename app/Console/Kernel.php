...
//            $schedule->command('track:map --company=17')->everyMinute()->between('04:30', '21:00');
            ...
            $schedule->command('syrus:sync-photos --imei=357042066532541')->everyMinute()->between('00:00', '23:59'); // Vehicle 001 Transpubenza
            $schedule->command('rocket:count --vehicle-plate=TST-001 --pa=3 --pr=5')->everyTenMinutes();


            $schedule->command('syrus:sync-photos --imei=352557100790404')->everyMinute()->between('00:00', '23:59'); // Vehicle 2819 Expreso Palmira
