        ...
        switch ($action) {
            ...
            case 'editRecorders':
                ...
                if ($user->canEditFields()) {
                    ...
                    if($dr) {
                        try {
                            DB::update("UPDATE registrodespacho SET $field = $valueDB, edit_user_id = $user->id, edited_info = edited_info || 'User $user->id > $field = $value, ', ignore_trigger = TRUE WHERE id_registro = $id");
                        }
