...
class PassengerReportDetailedController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('reports.passengers.recorders.detailed.days.index', compact('companies'));
    }
    ...
    public function show(Request $request)
    {
        ...
        return view('reports.passengers.recorders.detailed.days.passengersReport', compact('passengerReport'));
    }
    ...
    public function buildPassengerReport($company, $dateReport)
    {
        ...
        $dispatchRegisters = DispatchRegister::active()->whereIn('route_id', $routes->pluck('id'))->where('date', $dateReport)->get()
            ->sortBy('id');
