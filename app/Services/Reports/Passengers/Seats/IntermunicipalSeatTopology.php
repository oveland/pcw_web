...
class IntermunicipalSeatTopology extends SeatTopology
{
    ...
    function makeHtmlTemplate(Passenger $passenger)
    {
        ...
        return view('reports.passengers.sensors.seats.topologies.intermunicipal', compact(['seatingStatus', 'hexSeating']));
    }
}