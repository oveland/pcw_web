...
class RouteTaking extends Model
{
    ...
    protected $guarded = ['fuel_gallons', 'net_production'];
    protected $fillable = ["total_production", "passenger_tariff", "control", "fuel_tariff", "fuel", "others", "bonus", "advance", "balance", "observations", "fuel_station_id", "counter", "type", "parent_takings_id", "manual_total_production", "manual_total_passengers"];
