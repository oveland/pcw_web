        ...
        <div v-if="liquidations.length">
            ...
            <div class="row" v-if="report">
                <div class="table-responsive phase-container col-md-12 m-t-10">
                    <road-safety-takings-turns-table-component :readonly="true" :costs-list="costs" :marks="report.marks" :totals="report.totals" :liquidation="report.details"></road-safety-takings-turns-table-component>
...
<script>
    ...
    import RoadSafetyTakingsTurnsTableComponent from './RoadSafetyTakingsTurnsTableComponent';
    ...
    export default {
        ...
        components: {
            RoadSafetyTakingsTurnsTableComponent,
            VueFriendlyIframe
        },
    }
</script>
