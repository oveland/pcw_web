    ...
    <div class="row" style="min-height: 400px">
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-9 col-md-8 col-sm-6 col-xs-12">
                <button class="btn btn-success btn-outline btn-sm btn-white sbold uppercase btn-circle pull-right tooltips" :title="$t('Create')" @click="info('Funcionalidad en desarrollo...')">
                    ...
                    <div class="modal-body">
                        <div class="col-md-12 text-left no-padding" v-if="editingCost">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-md-line-input has-success">
                                    <div class="input-icon">
                                        <input id="edit-cost-concept" type="text" class="form-control" :placeholder="$t('Concept')" autofocus v-model="editingCost.concept">
