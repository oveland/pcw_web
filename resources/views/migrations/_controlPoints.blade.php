                    ...
                    <div class="col-md-10">
                        ...
                        <div class="m-t-2">
                            ...
                            <div class="pull-right m-t-3">
                                <i class="fa fa-clock-o fa-spin text-danger" aria-hidden="true"></i>
                                <span title="@lang('Time from dispatch') - @lang('Business day')" class="label label-inverse">{{ isset($controlPointTimes[0])?$controlPointTimes[0]->time_from_dispatch:'None' }}</span>
                                <span class="label label-grey">{{ isset($controlPointTimes[0])?$controlPointTimes[1]->time_from_dispatch:'None' }}</span>
                                <span class="label label-default">{{ isset($controlPointTimes[0])?$controlPointTimes[2]->time_from_dispatch:'None' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
