...
@section('content')
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">@lang('Maintenance')</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header"><i class="fa fa-cogs" aria-hidden="true"></i> @lang('Administration')
        <small><i class="fa fa-hand-o-right" aria-hidden="true"></i> @lang('Maintenance')</small>
    </h1>
    ...
    <div class="row">
        <!-- begin search form -->
        <form class="col-md-12 form-search-report" action="{{ route('admin-vehicles-maintenance-show') }}" style="z-index: 999;">
