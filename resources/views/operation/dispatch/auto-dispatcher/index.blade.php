...
@section('content')
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="hide"><a href="javascript:;">@lang('Dispatch')</a></li>
        <li class="active">@lang('Auto Dispatcher')</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    ...
    <div class="row">
        <!-- begin search form -->
        <form class="col-md-12 form-search-operation" action="{{ route('operation-dispatch-auto-dispatcher-show') }}">
