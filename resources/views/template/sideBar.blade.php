                        ...
                        <ul class="sub-menu">
                            ...
                            @if( Auth::user()->isAdmin() )
                                <li class="has-sub menu-passengers-mixed">
                                    <a href="{{ route('report-passengers-mixed')  }}" class="faa-parent animated-hover">
                            ...
                            <li class="has-sub menu-passengers-geolocation">
                                <a href="{{ route('report-passengers-geolocation')  }}" class="faa-parent animated-hover">
