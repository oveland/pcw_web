...
@section('content')
    ...
    <div class="row">
        <!-- begin search form -->
        <form class="col-md-12 form-search-report" action="{{ route('report-passengers-recorders-consolidated-daily-search') }}">
...
@section('scripts')
    <script type="application/javascript">
        $('.menu-passengers, .menu-passengers-recorders, .menu-passengers-recorders-consolidated, .menu-passengers-recorders-consolidated-days').addClass('active-animated');
