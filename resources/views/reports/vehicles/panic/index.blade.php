...
@section('content')
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">@lang('Panic')</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">@lang('Route report')
        <small><i class="fa fa-hand-o-right" aria-hidden="true"></i> @lang('Panic')</small>
    </h1>
    ...
    <div class="row">
        ...
        <!-- begin search form -->
        <form class="col-md-12 form-search-report" action="{{ route('report-vehicle-panic-search-report') }}">
