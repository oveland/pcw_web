            ...
            <div class="row">
                <div class="col-md-11">
                    <ul class="nav nav-pills nav-pills-success m-0">
                        @foreach($report as $vehicleId => $speedingReports)
                            @php
                                $vehicle = $speedingReports->first()['vehicle'];
                            @endphp
                        ...
                        <table class="table table-bordered table-striped table-hover table-valign-middle table-report">
                            ...
                            @foreach($speedingReports as $speeding)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $speeding->date }}</td>
                                    <td class="text-center">{{ $speeding->vehicle->number }}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if($dispatchRegister)
                                            <a href="#modal-route-report"
                                               ...
                                               data-toggle="modal"
                                               data-url="{{ route('report-route-chart',['dispatchRegister'=>$speeding->dispatchRegister->id]) }}?centerOnLocation={{ $speeding->id }}"
                                               data-url-off-road-report="{{ route('report-route-off-road',['dispatchRegister'=>$speeding->dispatchRegister->id]) }}"
