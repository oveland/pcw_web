...
@section('content')
    ...
    <div class="row">
        <!-- begin search form -->
        <form class="col-md-12 form-search-report" action="{{ route('report-drivers-consolidated-search') }}">
...
@section('scripts')
    <script type="application/javascript">
        $('.menu-drivers, .menu-drivers-consolidated').addClass('active-animated');
